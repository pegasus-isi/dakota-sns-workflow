...
e_DakotaWrapper = Executable(name="DakotaWrapper", os="linux", arch="x86_64", installed=False)
e_DakotaWrapper.addPFN(PFN("file://" + os.getcwd() + "/bin/DakotaWrapper.sh", "condorpool"))
dax.addExecutable(e_DakotaWrapper)

e_DS = Executable(name="DS.py", os="linux", arch="x86_64", installed=False)
e_DS.addPFN(PFN("file://" + os.getcwd() + "/bin/DS.py", "condorpool"))
dax.addExecutable(e_DS)

e_DSout = Executable(name="DSout", os="linux", arch="x86_64", installed=False)
